        ...
        Docs.classData ={"id":"apidocs","iconCls":"icon-docs","text":"API Documentation","singleClickExpand":true,"children":[
                ...
                {"href":"output/Ext.ux.form.FileUploadField.html","text":"FileUploadField","id":"Ext.ux.form.FileUploadField","isClass":true,"iconCls":"icon-cmp","cls":"cls","leaf":true}
                ,
                {"href":"output/Ext.ux.form.ItemSelector.html","text":"ItemSelector","id":"Ext.ux.form.ItemSelector","isClass":true,"iconCls":"icon-cmp","cls":"cls","leaf":true}
                ,
                {"href":"output/Ext.ux.form.MultiSelect.html","text":"MultiSelect","id":"Ext.ux.form.MultiSelect","isClass":true,"iconCls":"icon-cmp","cls":"cls","leaf":true}
                ,
                {"href":"output/Ext.ux.form.SelectBox.html","text":"SelectBox","id":"Ext.ux.form.SelectBox","isClass":true,"iconCls":"icon-cmp","cls":"cls","leaf":true}
                ,
                {"href":"output/Ext.ux.form.SpinnerField.html","text":"SpinnerField","id":"Ext.ux.form.SpinnerField","isClass":true,"iconCls":"icon-cmp","cls":"cls","leaf":true}
                ]}
                ,
                ...
                ,
                {"href":"output/Ext.ux.grid.RowEditor.html","text":"RowEditor","id":"Ext.ux.grid.RowEditor","isClass":true,"iconCls":"icon-cmp","cls":"cls","leaf":true}
                ,
                ...
                ,
                {"href":"output/Ext.ux.grid.TableGrid.html","text":"TableGrid","id":"Ext.ux.grid.TableGrid","isClass":true,"iconCls":"icon-cmp","cls":"cls","leaf":true}
                ]}
                ,
                ...
                {"href":"output/Ext.ux.menu.ListMenu.html","text":"ListMenu","id":"Ext.ux.menu.ListMenu","isClass":true,"iconCls":"icon-cmp","cls":"cls","leaf":true}
                ,
                {"href":"output/Ext.ux.menu.RangeMenu.html","text":"RangeMenu","id":"Ext.ux.menu.RangeMenu","isClass":true,"iconCls":"icon-cmp","cls":"cls","leaf":true}
                ]}
                ,
                ...
                ,
                {"href":"output/Ext.ux.tree.ColumnTree.html","text":"ColumnTree","id":"Ext.ux.tree.ColumnTree","isClass":true,"iconCls":"icon-cmp","cls":"cls","leaf":true}
                ,
                ...
                ,
                {"href":"output/Ext.ux.GMapPanel.html","text":"GMapPanel","id":"Ext.ux.GMapPanel","isClass":true,"iconCls":"icon-cmp","cls":"cls","leaf":true}
                ,
                ...
                ,
                {"href":"output/Ext.ux.SliderTip.html","text":"SliderTip","id":"Ext.ux.SliderTip","isClass":true,"iconCls":"icon-cmp","cls":"cls","leaf":true}
                ,
                ...
                ,
                {"href":"output/Ext.ux.ValidationStatus.html","text":"ValidationStatus","id":"Ext.ux.ValidationStatus","isClass":true,"iconCls":"icon-cmp","cls":"cls","leaf":true}
                ]}
                ,
                ...
                ,
                {"href":"output/Ext.DataView.LabelEditor.html","text":"DataView.LabelEditor","id":"Ext.DataView.LabelEditor","isClass":true,"iconCls":"icon-cmp","cls":"cls","leaf":true}
                ,
        ...
        Docs.icons = {
            ...
            ,
            "Ext.ux.form.FileUploadField":"icon-cmp"
            ,
            "Ext.ux.form.ItemSelector":"icon-cmp"
            ,
            "Ext.ux.form.MultiSelect":"icon-cmp"
            ,
            "Ext.ux.form.SelectBox":"icon-cmp"
            ,
            "Ext.ux.form.SpinnerField":"icon-cmp"
            ,
            ...
            ,
            "Ext.ux.grid.RowEditor":"icon-cmp"
            ,
            "Ext.ux.grid.RowExpander":"icon-cls"
            ,
            "Ext.ux.grid.TableGrid":"icon-cmp"
            ,
            "Ext.ux.layout.CenterLayout":"icon-cls"
            ,
            "Ext.ux.layout.RowLayout":"icon-cls"
            ,
            "Ext.ux.menu.ListMenu":"icon-cmp"
            ,
            "Ext.ux.menu.RangeMenu":"icon-cmp"
            ,
            "Ext.ux.tree.ColumnNodeUI":"icon-cls"
            ,
            "Ext.ux.tree.ColumnTree":"icon-cmp"
            ,
            ...
            ,
            "Ext.ux.GMapPanel":"icon-cmp"
            ,
            "Ext.ux.ProgressBarPager":"icon-cls"
            ,
            "Ext.ux.SliderTip":"icon-cmp"
            ,
            ...
            ,
            "Ext.ux.ValidationStatus":"icon-cmp"
            ,
            "Ext.Action":"icon-cls"
            ,
            ...
            ,
            "Ext.DataView.LabelEditor":"icon-cmp"
            ,
